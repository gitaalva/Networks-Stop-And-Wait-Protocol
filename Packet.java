public class Packet
{
    ...
    public Packet(int seq, int ack, int check, String newPayload, int[] sackA )
    {
        seqnum = seq;
        acknum = ack;
        checksum = check;
    ...
    public Packet(int seq, int ack, int check, int sackArray[])
    {
        seqnum = seq;
        acknum = ack;
        checksum = check;
    ...
    public boolean setSack(int[] sackA)
    {
    	sack = sackA;
    	return true;
    }
